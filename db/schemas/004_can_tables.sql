...
INSERT INTO meta.actnow_intervention_types (id, name)
    VALUES (1, 'NO_INTERVENTION'), (2, 'WEAK_INTERVENTION'), (3, 'STRONG_INTERVENTION'), (4, 'OBSERVED_INTERVENTION');
...
INSERT INTO meta.actnow_timeseries_variables (id, name)
    VALUES (1, 'cumulative_deaths'), (2, 'cumulative_infected'), (3, 'cumulative_negative_tests'), (4, 'cumulative_positive_tests'), (5, 'hospital_bed_capacity'), (6, 'hospital_beds_required'), (7, 'icu_bed_capacity'), (8, 'icu_beds_in_use'), (9, 'rt_indicator'), (10, 'rt_indicator_ci_90'), (11, 'ventilator_capacity'), (12, 'ventilators_in_use');
...
INSERT INTO meta.actnow_actual_variables (id, name)
    VALUES (1, 'cumulative_confirmed_cases'), (2, 'cumulative_deaths'), (3, 'cumulative_negative_tests'), (4, 'cumulative_positive_tests'), (5, 'hospital_beds_capacity'), (6, 'hospital_beds_current_usage_covid'), (7, 'hospital_beds_current_usage_total'), (8, 'hospital_beds_total_capacity'), (9, 'hospital_beds_typical_usage_rate'), (10, 'icu_beds_capacity'), (11, 'icu_beds_current_usage_covid'), (12, 'icu_beds_current_usage_total'), (13, 'icu_beds_total_capacity'), (14, 'icu_beds_typical_usage_rate');
...
COMMENT ON COLUMN data.actnow_timeseries.value IS E'The value of the variable for the state (or county), date, as of vintage, assuming a particular intervention time';
